    ...
    function updateDragLines(activeIndex, forceUpdate = false) {
      ...
      lines.forEach(line => {
        ...
        line.style.backgroundColor = "var(--color-gold-line)";
      ...
      gsap.ticker.add(() => {
        ...
        if (progress > p_TextOut) {
          ...
          if (progress <= p_Tumble) {
            ...
            gsap.set(faceFront, { boxShadow: 'inset 0 0 40px rgba(253, 250, 246, 1)', border: '1px solid var(--color-gold-line)' });
            ...
            gsap.set(faceFront, {
              ...
              boxShadow: `inset 0 0 ${40 * (1 - ease)}px rgba(253, 250, 246, 1)`,
